...
sections:
  ...
  - block: markdown
    content:
      title: 'Пара слов о моем опыте в Hugo'
      subtitle: ''
      text: |-
        Сайт подготовлен Козиным Иваном. Стоит сказать что это было не очень сложно, но получился он честно говоря таким что пользоваться я врядли буду. :) 
    design:
      columns: '1'
